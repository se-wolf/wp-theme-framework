...
function the_pagination () { echo '<nav class="pagination">' . paginate_links( array( 'prev_text' => '' , 'next_text' => '' ) ) . '</nav>'; }
...
function is_block_editor () {
	...
	if ( has_classic_editor() ) return in_array( get_option( 'classic-editor-replace' ) , array( 'no-replace' , 'block' ) , true );
    return true;
}
